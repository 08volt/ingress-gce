...
func TestEndpointsCalculatorMode(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"L4 ILB Local Mode", NewPortInfoMapForVMIPNEG("testns", "testsvc", testContext.L4Namer, true, defaultNetwork, L4InternalLB, false), L4LocalMode},
		{"L4 ILB Cluster Mode", NewPortInfoMapForVMIPNEG("testns", "testsvc", testContext.L4Namer, false, defaultNetwork, L4InternalLB, false), L4ClusterMode},
		{"L4 NetLB Local Mode", NewPortInfoMapForVMIPNEG("testns", "testsvc", testContext.L4Namer, true, defaultNetwork, L4ExternalLB, false), L4LocalMode},
		{"L4 NetLB Cluster Mode", NewPortInfoMapForVMIPNEG("testns", "testsvc", testContext.L4Namer, false, defaultNetwork, L4ExternalLB, false), L4ClusterMode},
